...
PokemonTower6F_Object:
	...
	object_event  6,  8, SPRITE_POKE_BALL, WALK, NONE, TEXT_POKEMONTOWER6F_RARE_CANDY, RARE_CANDY
	object_event 14, 14, SPRITE_POKE_BALL, WALK, NONE, TEXT_POKEMONTOWER6F_X_ACCURACY, X_ACCURACY
