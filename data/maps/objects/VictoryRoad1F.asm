...
VictoryRoad1F_Object:
	...
	object_event 11,  0, SPRITE_POKE_BALL, WALK, NONE, TEXT_VICTORYROAD1F_TM_SKY_ATTACK, TM_SKY_ATTACK
	object_event  9,  2, SPRITE_POKE_BALL, WALK, NONE, TEXT_VICTORYROAD1F_RARE_CANDY, RARE_CANDY
