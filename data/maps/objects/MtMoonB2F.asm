...
MtMoonB2F_Object:
	...
	object_event 25, 21, SPRITE_POKE_BALL, WALK, NONE, TEXT_MTMOONB2F_HP_UP, HP_UP
	object_event 29,  5, SPRITE_POKE_BALL, WALK, NONE, TEXT_MTMOONB2F_TM_MEGA_PUNCH, TM_MEGA_PUNCH
