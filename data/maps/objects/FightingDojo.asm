...
FightingDojo_Object:
	...
	object_event  4,  1, SPRITE_POKE_BALL, WALK, NONE, TEXT_FIGHTINGDOJO_HITMONLEE_POKE_BALL
	object_event  5,  1, SPRITE_POKE_BALL, WALK, NONE, TEXT_FIGHTINGDOJO_HITMONCHAN_POKE_BALL
