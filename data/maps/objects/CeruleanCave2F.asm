...
CeruleanCave2F_Object:
	...
	def_object_events
	object_event  0, 11, SPRITE_POKE_BALL, WALK, NONE, TEXT_CERULEANCAVE2F_RARE_CANDY, RARE_CANDY
	object_event 16,  7, SPRITE_POKE_BALL, WALK, NONE, TEXT_CERULEANCAVE2F_ULTRA_BALL, ULTRA_BALL
	object_event 19, 11, SPRITE_POKE_BALL, WALK, NONE, TEXT_CERULEANCAVE2F_MAX_REVIVE, MAX_REVIVE
	object_event 27,  9, SPRITE_POKE_BALL, WALK, NONE, TEXT_CERULEANCAVE2F_FULL_RESTORE, FULL_RESTORE
