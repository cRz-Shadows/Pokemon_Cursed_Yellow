...
CeruleanCave1F_Object:
	...
	def_object_events
	object_event 29, 16, SPRITE_POKE_BALL, WALK, NONE, TEXT_CERULEANCAVE1F_RARE_CANDY, RARE_CANDY
	object_event  7, 11, SPRITE_POKE_BALL, WALK, NONE, TEXT_CERULEANCAVE1F_MAX_ELIXER, MAX_ELIXER
	object_event 29,  9, SPRITE_POKE_BALL, WALK, NONE, TEXT_CERULEANCAVE1F_MAX_REVIVE, MAX_REVIVE
	object_event 18,  3, SPRITE_POKE_BALL, WALK, NONE, TEXT_CERULEANCAVE1F_ULTRA_BALL, ULTRA_BALL
