...
MtMoon1F_Object:
	...
	object_event  2, 20, SPRITE_POKE_BALL, WALK, NONE, TEXT_MTMOON1F_POTION1, POTION
	object_event  2,  2, SPRITE_POKE_BALL, WALK, NONE, TEXT_MTMOON1F_MOON_STONE, MOON_STONE
	object_event 35, 31, SPRITE_POKE_BALL, WALK, NONE, TEXT_MTMOON1F_RARE_CANDY, RARE_CANDY
	object_event 36, 23, SPRITE_POKE_BALL, WALK, NONE, TEXT_MTMOON1F_ESCAPE_ROPE, ESCAPE_ROPE
	object_event 20, 33, SPRITE_POKE_BALL, WALK, NONE, TEXT_MTMOON1F_POTION2, POTION
	object_event  5, 32, SPRITE_POKE_BALL, WALK, NONE, TEXT_MTMOON1F_TM_WATER_GUN, TM_WATER_GUN
