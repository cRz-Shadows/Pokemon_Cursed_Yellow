...
SilphCo5F_Object:
	...
	object_event  2, 13, SPRITE_POKE_BALL, WALK, NONE, TEXT_SILPHCO5F_TM_TAKE_DOWN, TM_TAKE_DOWN
	object_event  4,  6, SPRITE_POKE_BALL, WALK, NONE, TEXT_SILPHCO5F_PROTEIN, PROTEIN
	object_event 21, 16, SPRITE_POKE_BALL, WALK, NONE, TEXT_SILPHCO5F_CARD_KEY, CARD_KEY
