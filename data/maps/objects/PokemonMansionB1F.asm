...
PokemonMansionB1F_Object:
	...
	object_event 10,  2, SPRITE_POKE_BALL, WALK, NONE, TEXT_POKEMONMANSIONB1F_RARE_CANDY, RARE_CANDY
	object_event  1, 22, SPRITE_POKE_BALL, WALK, NONE, TEXT_POKEMONMANSIONB1F_FULL_RESTORE, FULL_RESTORE
	object_event 19, 25, SPRITE_POKE_BALL, WALK, NONE, TEXT_POKEMONMANSIONB1F_TM_BLIZZARD, TM_BLIZZARD
	object_event  5,  4, SPRITE_POKE_BALL, WALK, NONE, TEXT_POKEMONMANSIONB1F_TM_SOLARBEAM, TM_SOLARBEAM
	object_event 16, 20, SPRITE_POKEDEX, STAY, NONE, TEXT_POKEMONMANSIONB1F_DIARY
	object_event  5, 13, SPRITE_POKE_BALL, WALK, NONE, TEXT_POKEMONMANSIONB1F_SECRET_KEY, SECRET_KEY
