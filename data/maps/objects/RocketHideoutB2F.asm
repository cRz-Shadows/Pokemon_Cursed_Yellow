...
RocketHideoutB2F_Object:
	...
	object_event  1, 11, SPRITE_POKE_BALL, WALK, NONE, TEXT_ROCKETHIDEOUTB2F_MOON_STONE, MOON_STONE
	object_event 16,  8, SPRITE_POKE_BALL, WALK, NONE, TEXT_ROCKETHIDEOUTB2F_NUGGET, NUGGET
	object_event  6, 12, SPRITE_POKE_BALL, WALK, NONE, TEXT_ROCKETHIDEOUTB2F_TM_HORN_DRILL, TM_HORN_DRILL
	object_event  3, 21, SPRITE_POKE_BALL, WALK, NONE, TEXT_ROCKETHIDEOUTB2F_SUPER_POTION, SUPER_POTION
