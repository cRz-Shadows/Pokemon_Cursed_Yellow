...
CeruleanCaveB1F_Object:
	...
	object_event 26,  1, SPRITE_POKE_BALL, WALK, NONE, TEXT_CERULEANCAVEB1F_ULTRA_BALL1, ULTRA_BALL
	object_event  2, 13, SPRITE_POKE_BALL, WALK, NONE, TEXT_CERULEANCAVEB1F_ULTRA_BALL2, ULTRA_BALL
	object_event  3, 13, SPRITE_POKE_BALL, WALK, NONE, TEXT_CERULEANCAVEB1F_MAX_REVIVE, MAX_REVIVE
	object_event 15,  3, SPRITE_POKE_BALL, WALK, NONE, TEXT_CERULEANCAVEB1F_MAX_ELIXER, MAX_ELIXER
