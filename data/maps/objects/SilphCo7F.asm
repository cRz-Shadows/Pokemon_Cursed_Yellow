...
SilphCo7F_Object:
	...
	object_event  1,  9, SPRITE_POKE_BALL, WALK, NONE, TEXT_SILPHCO7F_CALCIUM, CALCIUM
	object_event 24, 11, SPRITE_POKE_BALL, WALK, NONE, TEXT_SILPHCO7F_TM_SWORDS_DANCE, TM_SWORDS_DANCE
