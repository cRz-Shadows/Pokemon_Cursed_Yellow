...
RocketHideoutB3F_Object:
	...
	object_event 26, 17, SPRITE_POKE_BALL, WALK, NONE, TEXT_ROCKETHIDEOUTB3F_TM_DOUBLE_EDGE, TM_DOUBLE_EDGE
	object_event 20, 14, SPRITE_POKE_BALL, WALK, NONE, TEXT_ROCKETHIDEOUTB3F_RARE_CANDY, RARE_CANDY
