...
PokemonTower4F_Object:
	...
	object_event 12, 10, SPRITE_POKE_BALL, WALK, NONE, TEXT_POKEMONTOWER4F_ELIXER, ELIXER
	object_event  9, 10, SPRITE_POKE_BALL, WALK, NONE, TEXT_POKEMONTOWER4F_AWAKENING, AWAKENING
	object_event 12, 16, SPRITE_POKE_BALL, WALK, NONE, TEXT_POKEMONTOWER4F_HP_UP, HP_UP
