...
VictoryRoad3F_Object:
	...
	object_event 26,  5, SPRITE_POKE_BALL, WALK, NONE, TEXT_VICTORYROAD3F_MAX_REVIVE, MAX_REVIVE
	object_event  7,  7, SPRITE_POKE_BALL, WALK, NONE, TEXT_VICTORYROAD3F_TM_EXPLOSION, TM_EXPLOSION
