...
SilphCo4F_Object:
	...
	object_event  3,  9, SPRITE_POKE_BALL, WALK, NONE, TEXT_SILPHCO4F_FULL_HEAL, FULL_HEAL
	object_event  4,  7, SPRITE_POKE_BALL, WALK, NONE, TEXT_SILPHCO4F_MAX_REVIVE, MAX_REVIVE
	object_event  5,  8, SPRITE_POKE_BALL, WALK, NONE, TEXT_SILPHCO4F_ESCAPE_ROPE, ESCAPE_ROPE
