...
PokemonMansion1F_Object:
	...
	object_event 14,  3, SPRITE_POKE_BALL, WALK, NONE, TEXT_POKEMONMANSION1F_ESCAPE_ROPE, ESCAPE_ROPE
	object_event 18, 21, SPRITE_POKE_BALL, WALK, NONE, TEXT_POKEMONMANSION1F_CARBOS, CARBOS
