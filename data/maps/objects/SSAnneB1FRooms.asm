...
SSAnneB1FRooms_Object:
	...
	object_event 20,  2, SPRITE_POKE_BALL, WALK, NONE, TEXT_SSANNEB1FROOMS_ETHER, ETHER
	object_event 10,  2, SPRITE_POKE_BALL, WALK, NONE, TEXT_SSANNEB1FROOMS_TM_REST, TM_REST
	object_event 12, 11, SPRITE_POKE_BALL, WALK, NONE, TEXT_SSANNEB1FROOMS_MAX_POTION, MAX_POTION
