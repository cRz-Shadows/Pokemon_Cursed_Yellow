...
ViridianForest_Object:
	...
	bg_event 26, 18, TEXT_VIRIDIANFOREST_TRAINER_TIPS2
	bg_event  4, 24, TEXT_VIRIDIANFOREST_TRAINER_TIPS3
	bg_event 18, 42, TEXT_VIRIDIANFOREST_TRAINER_TIPS4
	...
	object_event  2, 41, SPRITE_COOLTRAINER_F, STAY, NONE, TEXT_VIRIDIANFOREST_COOLTRAINER_F, OPP_LASS, 19
	object_event 13, 17, SPRITE_YOUNGSTER, STAY, RIGHT, TEXT_VIRIDIANFOREST_YOUNGSTER5, OPP_BUG_CATCHER, 15
	object_event 25, 11, SPRITE_POKE_BALL, WALK, NONE, TEXT_VIRIDIANFOREST_POTION1, POTION
	object_event 12, 29, SPRITE_POKE_BALL, WALK, NONE, TEXT_VIRIDIANFOREST_POTION2, POTION
	object_event  1, 31, SPRITE_POKE_BALL, WALK, NONE, TEXT_VIRIDIANFOREST_POKE_BALL, POKE_BALL
