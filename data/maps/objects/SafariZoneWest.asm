...
SafariZoneWest_Object:
	...
	def_object_events
	object_event  8, 20, SPRITE_POKE_BALL, WALK, NONE, TEXT_SAFARIZONEWEST_MAX_POTION, MAX_POTION
	object_event  9,  7, SPRITE_POKE_BALL, WALK, NONE, TEXT_SAFARIZONEWEST_TM_DOUBLE_TEAM, TM_DOUBLE_TEAM
	object_event 18, 18, SPRITE_POKE_BALL, WALK, NONE, TEXT_SAFARIZONEWEST_MAX_REVIVE, MAX_REVIVE
	object_event 19,  7, SPRITE_POKE_BALL, WALK, NONE, TEXT_SAFARIZONEWEST_GOLD_TEETH, GOLD_TEETH
