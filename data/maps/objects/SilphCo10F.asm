...
SilphCo10F_Object:
	...
	object_event  2, 12, SPRITE_POKE_BALL, WALK, NONE, TEXT_SILPHCO10F_TM_EARTHQUAKE, TM_EARTHQUAKE
	object_event  4, 14, SPRITE_POKE_BALL, WALK, NONE, TEXT_SILPHCO10F_RARE_CANDY, RARE_CANDY
	object_event  5, 11, SPRITE_POKE_BALL, WALK, NONE, TEXT_SILPHCO10F_CARBOS, CARBOS
