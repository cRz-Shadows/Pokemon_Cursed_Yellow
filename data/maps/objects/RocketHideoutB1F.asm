...
RocketHideoutB1F_Object:
	...
	object_event 11, 14, SPRITE_POKE_BALL, WALK, NONE, TEXT_ROCKETHIDEOUTB1F_ESCAPE_ROPE, ESCAPE_ROPE
	object_event  9, 17, SPRITE_POKE_BALL, WALK, NONE, TEXT_ROCKETHIDEOUTB1F_HYPER_POTION, HYPER_POTION
