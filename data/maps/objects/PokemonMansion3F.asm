...
PokemonMansion3F_Object:
	...
	object_event  1, 16, SPRITE_POKE_BALL, WALK, NONE, TEXT_POKEMONMANSION3F_MAX_POTION, MAX_POTION
	object_event 25,  5, SPRITE_POKE_BALL, WALKS, NONE, TEXT_POKEMONMANSION3F_IRON, IRON
