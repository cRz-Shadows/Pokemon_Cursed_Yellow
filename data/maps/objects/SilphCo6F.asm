...
SilphCo6F_Object:
	...
	object_event  3, 12, SPRITE_POKE_BALL, WALK, NONE, TEXT_SILPHCO6F_HP_UP, HP_UP
	object_event  2, 15, SPRITE_POKE_BALL, WALK, NONE, TEXT_SILPHCO6F_X_ACCURACY, X_ACCURACY
