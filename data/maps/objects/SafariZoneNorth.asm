...
SafariZoneNorth_Object:
	...
	def_object_events
	object_event 25,  1, SPRITE_POKE_BALL, WALK, NONE, TEXT_SAFARIZONENORTH_PROTEIN, PROTEIN
	object_event 19,  7, SPRITE_POKE_BALL, WALK, NONE, TEXT_SAFARIZONENORTH_TM_SKULL_BASH, TM_SKULL_BASH
